 ...
 */
public class SectionsPagerAdapterSelf extends FragmentPagerAdapter {

    @StringRes
    private static final int[] TAB_TITLES = new int[]{R.string.tab_text_1, R.string.tab_text_2};
    private final Context mContext;

    public SectionsPagerAdapterSelf(Context context, FragmentManager fm) {
        super(fm);
        mContext = context;
    }
    ...
    public Fragment getItem(int position) {
        ...
        switch (position) {
            case 0:
                fragment = FragmentSelfDaily.newInstance("","");
                break;
            case 1:
                fragment = FragmentSelfWeekly.newInstance("","");
                break;
            case 2:
                fragment = FragmentSelfMonthly.newInstance("","");
                break;
        }
        return fragment;
    }
