 ...
 * {@link FragmentSchoolDaily.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link FragmentSchoolDaily#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentSchoolDaily extends Fragment {
    JSONArray json;
    View view;
    ...
    public static FragmentSchoolDaily newInstance(String param1, String param2) {
        FragmentSchoolDaily fragment = new FragmentSchoolDaily();
...
//        getAppTimes();
        new AsyncTask().execute(getResources().getString(R.string.domain) + "get_leaderboard_school.php?school_id=" + school_id);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_school_daily, container, false);
...
FirebaseCrashlytics.getInstance().recordException(e);
        ...
        protected void onPostExecute(String result) {
            ...
            if (result.equals("No results found\n")) {
                Snackbar.make(view.findViewById(R.id.fragment_school_daily_parent), "Updates times on server", Snackbar.LENGTH_SHORT).show();
            } else if (result.equals("Connection failed\n")) {
                Snackbar.make(view.findViewById(R.id.fragment_school_daily_parent), "Error 1: Endpoint could not connect to MySQL server", Snackbar.LENGTH_SHORT).show();
            } else if (result.equals("1\n")) {
//                Snackbar.make(view.findViewById(R.id.fragment_school_daily_parent), "Updated server with times", Snackbar.LENGTH_SHORT).show();
            } else {
                try {
                    json = new JSONArray(result);
                } catch (JSONException e) {
                    Snackbar.make(view.findViewById(R.id.fragment_school_daily_parent), "Error 2: Couldn't create JSONArray", Snackbar.LENGTH_SHORT).show();
                }
                LinearLayout linearLayout = view.findViewById(R.id.fragment_school_daily_linear_layout);
